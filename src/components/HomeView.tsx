...
const LUXURY_GAL_CARDS = [
  ...
  },
  {
    ...
    img: 'tic triage, providing acute cardiac monitoring and early-intervention guidance supported by real-time digital hemodynamic analysis.',
...
export default function HomeView({ onViewChange, onBookNow }: HomeViewProps) {
  ...
  const [mousePosition, setMousePosition] = useState({
    x: 0, https://lh3.googleusercontent.com/aidapublic/AB6AXuDIboAfRzk9tpRj_PQB0aUFIvqx82Vx9vb4MMY4NtfiPxoQXT9by4Cp8AQFZY5wzMngrh6elrZF8Gj8OqOPoyz9M4GmvwQWdWZ1VJ8NtNWsx8Na7KhzBYjUqaSN5Ib2zcOvq6p81WPOzGdYQF2eUb8uPWmL3rv5sd_-xAljJtE4PwBKPLtTiCNtrr38BUaY17DIbZS9upjCYYs8ywq5Ek6KAcDf1JiAK3eKPbec6wc0Nz0ybLHueBPokEV8vTD7SD5VdTb4hu_HFlM',
      desc: 'The clean hub for high-precision diagnos y: 0 });
...
className = "py-36 lg:py-48 relative bg-surface-container-low overflow-hidden"
  ...
  <div className="max-w-[1280px] mx-auto px-5 md:px-[64px] relative z-10">
    ...
    <div className="mt-16 w-full border-t border-outline-variant/60 pt-16 relative z-50">
        ...
        {filteredPricing.map((item, index) => {
          ...
          return (
            <motion.div
              ...
              className={`relative rounded-[28px] p-7.5 border flex flex-col justify-between transition-all duration-500 cursor-pointer overflow-hidden text-left h-full group ${item.popular
            ...
            >
              ...
              <div className={`absolute right-[-15px] bottom-[-10px] w-40 h-28 opacity-[0.04] transition-all duration-700 pointer-events-none select-none z-0 ${item.popular ? 'text-[#9E1B1B] group-hover:opacity-[0.14] group-hover:-translate-x-1' : 'text-primary group-hover:opacity-[0.11] group-hover:-translate-x-1'
                }`}>
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center justify-between gap-2.5 mb-6.5">
                  <span className={`font-mono text-[9px] font-extrabold uppercase tracking-widest px-2.5 py-1 rounded-md leading-none border ${item.popular
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className={`p-3 rounded-2xl shrink-0 transition-all duration-500 ring-1 ${item.popular
              ...
              <div className="border-t border-outline-variant/30 mt-6 pt-5 flex items-center justify-between gap-2 relative z-10">
                <div className="flex flex-col text-left">
                  ...
                  <span className={`font-sans text-[24px] sm:text-[26px] font-black tracking-tight leading-none pt-1 transition-transform origin-left duration-300 ${item.popular ? 'text-[#9E1B1B] group-hover:scale-105' : 'text-primary group-hover:scale-105'
                    }`}>
                    {item.price}
                  </span>
                </div>

                <div className={`flex items-center gap-1.5 px-4 py-2.5 rounded-2xl font-sans text-[10px] font-extrabold uppercase tracking-[0.16em] shadow-sm ring-1 transition-all duration-300 ${item.popular
